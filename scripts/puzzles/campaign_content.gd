...
static func rooms(id: String) -> Array:
	match id:
		...
		"laundry": return [
			...
			room("空槽中的木筏", "借助水位登上高台", [control("float_plate","plate",18,[],{"mass":3.0}),control("fill","latch",12,["float_plate"]),control("high_valve","latch",28,["fill"],{"y":4.0})], [], ["high_valve"], ["木箱能压住供水踏板，右侧另有一座升降台。","把箱子推入黄铜框，再回到左边开启灌水阀。","推箱压住踏板，开启灌水，再乘右侧升降台到上层开阀。"], {"crate":16.0,"upper":true,"lift":"fill","water":true}),
