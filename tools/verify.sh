...
suites=(progress gameplay controls stealth save_store chapter_rules platform
    ...
    mechanical_props save_v2 puzzle_hints puzzle_interactions full_routes puzzle_rooms room_repairs crate_surfaces device_guidance puzzle_presentation guidance_flow journey)
separator=""
